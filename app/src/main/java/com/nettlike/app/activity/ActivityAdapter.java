package com.nettlike.app.activity;
    ...
    public void onBindViewHolder(@NonNull ActivityViewHolder holder, int position) {
        ...
        switch (target.getType()){
            case Constants.NEW_POST:
                ...
                Post finalPost;
                if (targetPost.getId() != null) {
                    finalPost = targetPost;
                } else {
                    finalPost = targetPost.getPost();
                }
                ...
                holder.postTime.setText(calendarHelper.getIntervaledMessageTime(targetPost.getCreatedAt()));
                    ...
                    holder.postName.setOnClickListener(v -> {
                        ...
                        intent.putExtra("user id", finalPost.getCreatedBy().getId());
